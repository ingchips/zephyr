/* ingchipsUartDrv.c - Ingchips UART driver */
...
/**
 * @brief Driver for Ingchips UART
 *
 * Driver for Ingchips UART found namely on TI LM3S6965 board. It is similar to
...
struct uart_ingchips_dev_data_t {
...
static const struct uart_driver_api uart_ingchips_driver_api;
 ...
 * @return 0
 */
static int uart_ingchips_init(const struct device *dev)
{
	return 0;
	struct uart_ingchips_dev_data_t *data = dev->data;
	const struct uart_ingchips_config *config = dev->config;
	disable(dev);
...
static int uart_ingchips_poll_in(const struct device *dev, unsigned char *c)
{
	const struct uart_ingchips_config *config = dev->config;
 ...
 */
static int uart_ingchips_fifo_fill(const struct device *dev,
 ...
 */
static int uart_ingchips_fifo_read(const struct device *dev,
				    uint8_t *rx_data,
				    const int size)
{
	const struct uart_ingchips_config *config = dev->config;
 ...
 * @param dev UART device struct
 */
static void uart_ingchips_irq_tx_enable(const struct device *dev)
{
 ...
 * @param dev UART device struct
 */
static void uart_ingchips_irq_tx_disable(const struct device *dev)
{
	const struct uart_ingchips_config *config = dev->config;
 ...
 */
static int uart_ingchips_irq_tx_ready(const struct device *dev)
{
	const struct uart_ingchips_config *config = dev->config;
 ...
 * @param dev UART device struct
 */
static void uart_ingchips_irq_rx_enable(const struct device *dev)
{
	const struct uart_ingchips_config *config = dev->config;
 ...
 * @param dev UART device struct
 */
static void uart_ingchips_irq_rx_disable(const struct device *dev)
{
	const struct uart_ingchips_config *config = dev->config;
 ...
 */
static int uart_ingchips_irq_rx_ready(const struct device *dev)
{
	const struct uart_ingchips_config *config = dev->config;
 ...
 * @param dev UART device struct
 */
static void uart_ingchips_irq_err_enable(const struct device *dev)
{
	const struct uart_ingchips_config *config = dev->config;
 ...
 * @param dev UART device struct
 */
static void uart_ingchips_irq_err_disable(const struct device *dev)
{
	const struct uart_ingchips_config *config = dev->config;
 ...
 */
static int uart_ingchips_irq_is_pending(const struct device *dev)
{
	const struct uart_ingchips_config *config = dev->config;
 ...
 * @return Always 1
 */
static int uart_ingchips_irq_update(const struct device *dev)
{
	return 1;
}
 ...
 */
static void uart_ingchips_irq_callback_set(const struct device *dev,
					    uart_irq_callback_user_data_t cb,
					    void *cb_data)
{
	struct uart_ingchips_dev_data_t * const dev_data = dev->data;
 ...
 */
static void uart_ingchips_isr(const struct device *dev)
{
	struct uart_ingchips_dev_data_t * const dev_data = dev->data;
...
static const struct uart_driver_api uart_ingchips_driver_api = {
	.poll_in = uart_ingchips_poll_in,
	.poll_out = uart_ingchips_poll_out,

#ifdef CONFIG_UART_INTERRUPT_DRIVEN

	.fifo_fill = uart_ingchips_fifo_fill,
	.fifo_read = uart_ingchips_fifo_read,
	.irq_tx_enable = uart_ingchips_irq_tx_enable,
	.irq_tx_disable = uart_ingchips_irq_tx_disable,
	.irq_tx_ready = uart_ingchips_irq_tx_ready,
	.irq_rx_enable = uart_ingchips_irq_rx_enable,
	.irq_rx_disable = uart_ingchips_irq_rx_disable,
	.irq_rx_ready = uart_ingchips_irq_rx_ready,
	.irq_err_enable = uart_ingchips_irq_err_enable,
	.irq_err_disable = uart_ingchips_irq_err_disable,
	.irq_is_pending = uart_ingchips_irq_is_pending,
	.irq_update = uart_ingchips_irq_update,
	.irq_callback_set = uart_ingchips_irq_callback_set,
...
static const struct uart_ingchips_config uart_ingchips_dev_cfg_0 = {
...
static struct uart_ingchips_dev_data_t uart_ingchips_dev_data_0 = {
...
DEVICE_DT_INST_DEFINE(0,
		    &uart_ingchips_init,
		    NULL,
		    &uart_ingchips_dev_data_0, &uart_ingchips_dev_cfg_0,
		    PRE_KERNEL_1, CONFIG_SERIAL_INIT_PRIORITY,
		    &uart_ingchips_driver_api);
...
static void irq_config_func_0(const struct device *dev)
{
	IRQ_CONNECT(DT_INST_IRQN(0),
		    ...
		    uart_ingchips_isr, DEVICE_DT_INST_GET(0),
		    0);
...
static struct uart_ingchips_config uart_ingchips_dev_cfg_1 = {
...
static struct uart_ingchips_dev_data_t uart_ingchips_dev_data_1 = {
...
DEVICE_DT_INST_DEFINE(1,
		    &uart_ingchips_init,
		    NULL,
		    &uart_ingchips_dev_data_1, &uart_ingchips_dev_cfg_1,
		    PRE_KERNEL_1, CONFIG_SERIAL_INIT_PRIORITY,
		    &uart_ingchips_driver_api);
...
static void irq_config_func_1(const struct device *dev)
{
	IRQ_CONNECT(DT_INST_IRQN(1),
		    ...
		    uart_ingchips_isr, DEVICE_DT_INST_GET(1),
		    0);
...
static const struct uart_ingchips_config uart_ingchips_dev_cfg_2 = {
...
static struct uart_ingchips_dev_data_t uart_ingchips_dev_data_2 = {
...
DEVICE_DT_INST_DEFINE(2,
		    &uart_ingchips_init,
		    NULL,
		    &uart_ingchips_dev_data_2, &uart_ingchips_dev_cfg_2,
		    PRE_KERNEL_1, CONFIG_SERIAL_INIT_PRIORITY,
		    &uart_ing_driver_api);
...
static void irq_config_func_2(const struct device *dev)
{
	IRQ_CONNECT(DT_INST_IRQN(2),
		    ...
		    uart_ingchips_isr, DEVICE_DT_INST_GET(2),
		    0);
