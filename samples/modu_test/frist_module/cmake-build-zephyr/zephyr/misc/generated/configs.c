...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_IRQS, 47);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_SIZE, 356);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_BASE_ADDRESS, 0x2027000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_INGCHIPS_ING_FLASH_CONTROLLER_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_INGCHIPS_ING_GPIO_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_INGCHIPS_ING_UART_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_INGCHIPS_DRIVERS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_INGCHIPS_ING9168, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_QEMU_GDBSERVER_LISTEN_DEV, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_QEMU_EXTRA_FLAGS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_INGCHIPS_ING9168, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CPU_HAS_ARM_MPU, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_SWO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_INGCHIPS_ING9168_QEMU, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_VECTOR_IN_RAM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_SIZE, 39);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_BASE_ADDRESS, 0x20004358);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DYNAMIC_THREAD_POOL_SIZE, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_INGCHIPS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_INGCHIPS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_INGCHIPS, 1);
