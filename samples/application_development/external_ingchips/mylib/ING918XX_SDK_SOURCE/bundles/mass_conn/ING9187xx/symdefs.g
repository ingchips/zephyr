...
gap_disconnect = 0x00007431;
gap_disconnect_all = 0x0000745d;
gap_ext_create_connection = 0x0000749d;
...
gap_periodic_adv_term_sync = 0x00007649;
gap_read_periodic_adv_list_size = 0x000076d1;
gap_read_phy = 0x000076dd;
gap_read_remote_used_features = 0x000076e9;
gap_read_remote_version = 0x000076f5;
gap_read_rssi = 0x00007701;
gap_remove_whitelist = 0x0000770d;
gap_rmv_adv_set = 0x00007789;
gap_rmv_dev_from_periodic_list = 0x00007795;
gap_rx_test_v2 = 0x000077a5;
gap_set_adv_set_random_addr = 0x000077dd;
gap_set_callback_for_next_hci = 0x00007819;
gap_set_connection_parameter_range = 0x00007841;
...
gap_update_connection_parameters = 0x00007c39;
gap_vendor_tx_continuous_wave = 0x00007c7d;
gatt_client_cancel_write = 0x000081a5;
gatt_client_discover_characteristic_descriptors = 0x000081cb;
gatt_client_discover_characteristics_for_handle_range_by_uuid128 = 0x0000820b;
gatt_client_discover_characteristics_for_handle_range_by_uuid16 = 0x0000825b;
gatt_client_discover_characteristics_for_service = 0x000082ab;
gatt_client_discover_primary_services = 0x000082e1;
gatt_client_discover_primary_services_by_uuid128 = 0x00008313;
gatt_client_discover_primary_services_by_uuid16 = 0x00008357;
gatt_client_execute_write = 0x00008393;
gatt_client_find_included_services_for_service = 0x000083b9;
gatt_client_get_mtu = 0x000083e7;
gatt_client_is_ready = 0x00008489;
gatt_client_listen_for_characteristic_value_updates = 0x0000849f;
gatt_client_prepare_write = 0x000084c1;
gatt_client_read_characteristic_descriptor_using_descriptor_handle = 0x000084fd;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle = 0x00008527;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle_with_offset = 0x0000852d;
gatt_client_read_long_value_of_characteristic_using_value_handle = 0x0000855b;
gatt_client_read_long_value_of_characteristic_using_value_handle_with_offset = 0x00008561;
gatt_client_read_multiple_characteristic_values = 0x0000858f;
gatt_client_read_value_of_characteristic_using_value_handle = 0x000085bf;
gatt_client_read_value_of_characteristics_by_uuid128 = 0x000085ed;
gatt_client_read_value_of_characteristics_by_uuid16 = 0x00008639;
gatt_client_register_handler = 0x00008685;
gatt_client_reliable_write_long_value_of_characteristic = 0x00008691;
gatt_client_signed_write_without_response = 0x00008ac1;
gatt_client_write_characteristic_descriptor_using_descriptor_handle = 0x00008b85;
gatt_client_write_client_characteristic_configuration = 0x00008bbf;
gatt_client_write_long_characteristic_descriptor_using_descriptor_handle = 0x00008c11;
gatt_client_write_long_characteristic_descriptor_using_descriptor_handle_with_offset = 0x00008c21;
gatt_client_write_long_value_of_characteristic = 0x00008c5d;
gatt_client_write_long_value_of_characteristic_with_offset = 0x00008c6d;
gatt_client_write_value_of_characteristic = 0x00008ca9;
gatt_client_write_value_of_characteristic_without_response = 0x00008cdf;
hci_add_event_handler = 0x0000a205;
hci_power_control = 0x0000a9a9;
hci_register_acl_packet_handler = 0x0000ab5d;
...
ll_aes_encrypt = 0x0000ccc1;
ll_config = 0x0000cd3d;
ll_free = 0x0000cd73;
ll_get_heap_free_size = 0x0000cd7d;
ll_hint_on_ce_len = 0x0000cd91;
ll_legacy_adv_set_interval = 0x0000cdc9;
ll_malloc = 0x0000cdd9;
ll_query_timing_info = 0x0000cf11;
ll_register_hci_acl_previewer = 0x0000cf5d;
ll_scan_set_fixed_channel = 0x0000cfc1;
ll_set_adv_access_address = 0x0000d1d9;
ll_set_adv_coded_scheme = 0x0000d1e5;
ll_set_conn_acl_report_latency = 0x0000d215;
ll_set_conn_coded_scheme = 0x0000d245;
ll_set_conn_latency = 0x0000d271;
ll_set_conn_tx_power = 0x0000d2a1;
ll_set_def_antenna = 0x0000d2e9;
ll_set_initiating_coded_scheme = 0x0000d305;
ll_set_max_conn_number = 0x0000d311;
