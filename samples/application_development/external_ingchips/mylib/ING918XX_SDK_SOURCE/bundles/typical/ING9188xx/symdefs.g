...
uuid128_to_str = 0x00023265;
uuid_add_bluetooth_prefix = 0x000232bd;
uuid_has_bluetooth_prefix = 0x000232dd;
uxListRemove = 0x000232f9;
uxQueueMessagesWaiting = 0x00023321;
uxQueueMessagesWaitingFromISR = 0x00023349;
uxQueueSpacesAvailable = 0x00023365;
uxTaskGetStackHighWaterMark = 0x00023391;
uxTaskPriorityGet = 0x000233b1;
uxTaskPriorityGetFromISR = 0x000233cd;
vListInitialise = 0x00023487;
vListInitialiseItem = 0x0002349d;
vListInsert = 0x000234a3;
vListInsertEnd = 0x000234d3;
vPortEndScheduler = 0x000234ed;
vPortEnterCritical = 0x00023519;
vPortExitCritical = 0x0002355d;
vPortFree = 0x00023591;
vPortSuppressTicksAndSleep = 0x00023625;
vPortValidateInterruptPriority = 0x0002374d;
vQueueDelete = 0x000237a9;
vQueueWaitForMessageRestricted = 0x000237d5;
vTaskDelay = 0x0002381d;
vTaskInternalSetTimeOutState = 0x00023869;
vTaskMissedYield = 0x00023879;
vTaskPlaceOnEventList = 0x00023885;
vTaskPlaceOnEventListRestricted = 0x000238bd;
vTaskPriorityDisinheritAfterTimeout = 0x000238fd;
vTaskPrioritySet = 0x000239a9;
vTaskResume = 0x00023a71;
vTaskStartScheduler = 0x00023af5;
vTaskStepTick = 0x00023b85;
vTaskSuspend = 0x00023bb5;
vTaskSuspendAll = 0x00023c71;
vTaskSwitchContext = 0x00023c81;
xPortStartScheduler = 0x00023d29;
xQueueAddToSet = 0x00023df1;
xQueueCreateCountingSemaphore = 0x00023e15;
xQueueCreateCountingSemaphoreStatic = 0x00023e51;
xQueueCreateMutex = 0x00023e95;
xQueueCreateMutexStatic = 0x00023eab;
xQueueCreateSet = 0x00023ec5;
xQueueGenericCreate = 0x00023ecd;
xQueueGenericCreateStatic = 0x00023f19;
xQueueGenericReset = 0x00023f81;
xQueueGenericSend = 0x0002400d;
xQueueGenericSendFromISR = 0x00024179;
xQueueGiveFromISR = 0x00024239;
xQueueGiveMutexRecursive = 0x000242dd;
xQueueIsQueueEmptyFromISR = 0x0002431d;
xQueueIsQueueFullFromISR = 0x00024341;
xQueuePeek = 0x00024369;
xQueuePeekFromISR = 0x00024491;
xQueueReceive = 0x000244fd;
xQueueReceiveFromISR = 0x00024629;
xQueueRemoveFromSet = 0x000246bd;
xQueueSelectFromSet = 0x000246df;
xQueueSelectFromSetFromISR = 0x000246f1;
xQueueSemaphoreTake = 0x00024705;
xQueueTakeMutexRecursive = 0x00024871;
xTaskCheckForTimeOut = 0x000248b5;
xTaskCreate = 0x00024925;
xTaskCreateStatic = 0x00024981;
xTaskGetCurrentTaskHandle = 0x000249f1;
xTaskGetSchedulerState = 0x000249fd;
xTaskGetTickCount = 0x00024a19;
xTaskGetTickCountFromISR = 0x00024a25;
xTaskIncrementTick = 0x00024a35;
xTaskPriorityDisinherit = 0x00024b01;
xTaskPriorityInherit = 0x00024b95;
xTaskRemoveFromEventList = 0x00024c29;
xTaskResumeAll = 0x00024ca9;
xTaskResumeFromISR = 0x00024d71;
xTimerCreate = 0x00024dfd;
xTimerCreateStatic = 0x00024e31;
xTimerCreateTimerTask = 0x00024e69;
xTimerGenericCommand = 0x00024ed5;
xTimerGetExpiryTime = 0x00024f45;
xTimerGetTimerDaemonTaskHandle = 0x00024f65;
