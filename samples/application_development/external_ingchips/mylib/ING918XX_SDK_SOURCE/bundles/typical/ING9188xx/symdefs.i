...
--define_symbol uuid128_to_str=0x00023265
--define_symbol uuid_add_bluetooth_prefix=0x000232bd
--define_symbol uuid_has_bluetooth_prefix=0x000232dd
--define_symbol uxListRemove=0x000232f9
--define_symbol uxQueueMessagesWaiting=0x00023321
--define_symbol uxQueueMessagesWaitingFromISR=0x00023349
--define_symbol uxQueueSpacesAvailable=0x00023365
--define_symbol uxTaskGetStackHighWaterMark=0x00023391
--define_symbol uxTaskPriorityGet=0x000233b1
--define_symbol uxTaskPriorityGetFromISR=0x000233cd
--define_symbol vListInitialise=0x00023487
--define_symbol vListInitialiseItem=0x0002349d
--define_symbol vListInsert=0x000234a3
--define_symbol vListInsertEnd=0x000234d3
--define_symbol vPortEndScheduler=0x000234ed
--define_symbol vPortEnterCritical=0x00023519
--define_symbol vPortExitCritical=0x0002355d
--define_symbol vPortFree=0x00023591
--define_symbol vPortSuppressTicksAndSleep=0x00023625
--define_symbol vPortValidateInterruptPriority=0x0002374d
--define_symbol vQueueDelete=0x000237a9
--define_symbol vQueueWaitForMessageRestricted=0x000237d5
--define_symbol vTaskDelay=0x0002381d
--define_symbol vTaskInternalSetTimeOutState=0x00023869
--define_symbol vTaskMissedYield=0x00023879
--define_symbol vTaskPlaceOnEventList=0x00023885
--define_symbol vTaskPlaceOnEventListRestricted=0x000238bd
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000238fd
--define_symbol vTaskPrioritySet=0x000239a9
--define_symbol vTaskResume=0x00023a71
--define_symbol vTaskStartScheduler=0x00023af5
--define_symbol vTaskStepTick=0x00023b85
--define_symbol vTaskSuspend=0x00023bb5
--define_symbol vTaskSuspendAll=0x00023c71
--define_symbol vTaskSwitchContext=0x00023c81
--define_symbol xPortStartScheduler=0x00023d29
--define_symbol xQueueAddToSet=0x00023df1
--define_symbol xQueueCreateCountingSemaphore=0x00023e15
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00023e51
--define_symbol xQueueCreateMutex=0x00023e95
--define_symbol xQueueCreateMutexStatic=0x00023eab
--define_symbol xQueueCreateSet=0x00023ec5
--define_symbol xQueueGenericCreate=0x00023ecd
--define_symbol xQueueGenericCreateStatic=0x00023f19
--define_symbol xQueueGenericReset=0x00023f81
--define_symbol xQueueGenericSend=0x0002400d
--define_symbol xQueueGenericSendFromISR=0x00024179
--define_symbol xQueueGiveFromISR=0x00024239
--define_symbol xQueueGiveMutexRecursive=0x000242dd
--define_symbol xQueueIsQueueEmptyFromISR=0x0002431d
--define_symbol xQueueIsQueueFullFromISR=0x00024341
--define_symbol xQueuePeek=0x00024369
--define_symbol xQueuePeekFromISR=0x00024491
--define_symbol xQueueReceive=0x000244fd
--define_symbol xQueueReceiveFromISR=0x00024629
--define_symbol xQueueRemoveFromSet=0x000246bd
--define_symbol xQueueSelectFromSet=0x000246df
--define_symbol xQueueSelectFromSetFromISR=0x000246f1
--define_symbol xQueueSemaphoreTake=0x00024705
--define_symbol xQueueTakeMutexRecursive=0x00024871
--define_symbol xTaskCheckForTimeOut=0x000248b5
--define_symbol xTaskCreate=0x00024925
--define_symbol xTaskCreateStatic=0x00024981
--define_symbol xTaskGetCurrentTaskHandle=0x000249f1
--define_symbol xTaskGetSchedulerState=0x000249fd
--define_symbol xTaskGetTickCount=0x00024a19
--define_symbol xTaskGetTickCountFromISR=0x00024a25
--define_symbol xTaskIncrementTick=0x00024a35
--define_symbol xTaskPriorityDisinherit=0x00024b01
--define_symbol xTaskPriorityInherit=0x00024b95
--define_symbol xTaskRemoveFromEventList=0x00024c29
--define_symbol xTaskResumeAll=0x00024ca9
--define_symbol xTaskResumeFromISR=0x00024d71
--define_symbol xTimerCreate=0x00024dfd
--define_symbol xTimerCreateStatic=0x00024e31
--define_symbol xTimerCreateTimerTask=0x00024e69
--define_symbol xTimerGenericCommand=0x00024ed5
--define_symbol xTimerGetExpiryTime=0x00024f45
--define_symbol xTimerGetTimerDaemonTaskHandle=0x00024f65
