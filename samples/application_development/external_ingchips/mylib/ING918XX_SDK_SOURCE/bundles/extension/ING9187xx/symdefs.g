...
eTaskConfirmSleepModeStatus = 0x00006dad;
...
gap_set_connection_parameter_range = 0x00007839;
gap_set_data_length = 0x00007851;
gap_set_def_phy = 0x00007869;
gap_set_ext_adv_data = 0x00007879;
gap_set_ext_adv_enable = 0x00007891;
...
gap_set_periodic_adv_data = 0x00007ab9;
gap_set_periodic_adv_enable = 0x00007b29;
gap_set_periodic_adv_para = 0x00007b39;
gap_set_phy = 0x00007b51;
gap_set_random_device_address = 0x00007b6d;
gap_start_ccm = 0x00007b9d;
...
hci_power_control = 0x0000a999;
hci_register_acl_packet_handler = 0x0000ab4d;
kv_commit = 0x0000b2c1;
kv_get = 0x0000b31d;
kv_init = 0x0000b329;
kv_init_backend = 0x0000b3a9;
kv_put = 0x0000b3bd;
kv_remove = 0x0000b3c9;
kv_remove_all = 0x0000b3fd;
kv_value_modified = 0x0000b42d;
kv_value_modified_of_key = 0x0000b449;
kv_visit = 0x0000b455;
l2cap_add_event_handler = 0x0000b4e5;
l2cap_can_send_packet_now = 0x0000b4f5;
l2cap_create_le_credit_based_connection_request = 0x0000b6b1;
l2cap_credit_based_send = 0x0000b7f5;
l2cap_credit_based_send_continue = 0x0000b821;
l2cap_disconnect = 0x0000b89d;
l2cap_get_le_credit_based_connection_credits = 0x0000baed;
l2cap_get_peer_mtu_for_local_cid = 0x0000bb09;
l2cap_init = 0x0000bedd;
l2cap_le_send_flow_control_credit = 0x0000bfd3;
l2cap_max_le_mtu = 0x0000c2dd;
l2cap_register_packet_handler = 0x0000c405;
l2cap_register_service = 0x0000c411;
l2cap_request_can_send_now_event = 0x0000c521;
l2cap_request_connection_parameter_update = 0x0000c53b;
l2cap_send_echo_request = 0x0000ca15;
l2cap_unregister_service = 0x0000cad5;
le_device_db_add = 0x0000cb2d;
le_device_db_find = 0x0000cc05;
le_device_db_from_key = 0x0000cc31;
le_device_db_iter_cur = 0x0000cc39;
le_device_db_iter_cur_key = 0x0000cc3d;
le_device_db_iter_init = 0x0000cc41;
le_device_db_iter_next = 0x0000cc49;
le_device_db_remove_key = 0x0000cc6f;
ll_ackable_packet_alloc = 0x0000cc9b;
ll_ackable_packet_get_status = 0x0000cdcd;
ll_ackable_packet_run = 0x0000ce3d;
ll_ackable_packet_set_tx_data = 0x0000ced9;
ll_aes_encrypt = 0x0000cef5;
ll_channel_monitor_alloc = 0x0000cf71;
ll_channel_monitor_check_each_pdu = 0x0000cff3;
ll_channel_monitor_run = 0x0000d059;
ll_config = 0x0000d10d;
ll_free = 0x0000d143;
ll_get_heap_free_size = 0x0000d14d;
ll_hint_on_ce_len = 0x0000d161;
ll_legacy_adv_set_interval = 0x0000d199;
ll_lock_frequency = 0x0000d1a9;
ll_malloc = 0x0000d20d;
ll_query_timing_info = 0x0000d345;
ll_raw_packet_alloc = 0x0000d391;
ll_raw_packet_free = 0x0000d465;
ll_raw_packet_get_bare_rx_data = 0x0000d49d;
ll_raw_packet_get_rx_data = 0x0000d563;
ll_raw_packet_recv = 0x0000d605;
ll_raw_packet_send = 0x0000d6c1;
ll_raw_packet_set_bare_data = 0x0000d7a9;
ll_raw_packet_set_bare_mode = 0x0000d7e7;
ll_raw_packet_set_param = 0x0000d8ed;
ll_raw_packet_set_tx_data = 0x0000d94b;
ll_register_hci_acl_previewer = 0x0000d9b1;
ll_scan_set_fixed_channel = 0x0000da15;
ll_set_adv_access_address = 0x0000dc2d;
ll_set_adv_coded_scheme = 0x0000dc39;
ll_set_conn_acl_report_latency = 0x0000dc69;
ll_set_conn_coded_scheme = 0x0000dc99;
ll_set_conn_interval_unit = 0x0000dcc5;
ll_set_conn_latency = 0x0000dcd1;
ll_set_conn_tx_power = 0x0000dd01;
ll_set_def_antenna = 0x0000dd49;
ll_set_initiating_coded_scheme = 0x0000dd65;
ll_set_max_conn_number = 0x0000dd71;
ll_unlock_frequency = 0x0000de05;
