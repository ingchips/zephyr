...
att_server_request_can_send_now_event = 0x00006125;
att_set_db = 0x00006141;
att_set_read_callback = 0x00006155;
att_set_write_callback = 0x00006161;
bd_addr_cmp = 0x000062d1;
bd_addr_copy = 0x000062d7;
bd_addr_to_str = 0x000062e1;
big_endian_read_16 = 0x00006319;
big_endian_read_32 = 0x00006321;
big_endian_store_16 = 0x00006335;
big_endian_store_32 = 0x00006341;
btstack_config = 0x00006479;
btstack_memory_pool_create = 0x000065c7;
btstack_memory_pool_free = 0x000065f1;
btstack_memory_pool_get = 0x00006651;
btstack_push_user_msg = 0x00006699;
btstack_push_user_runnable = 0x000066a5;
btstack_reset = 0x000066b1;
char_for_nibble = 0x00006975;
...
gap_set_callback_for_next_hci = 0x00007685;
gap_set_connection_parameter_range = 0x000076a5;
gap_set_data_length = 0x000076bd;
gap_set_def_phy = 0x000076d5;
gap_set_ext_adv_data = 0x000076e5;
gap_set_ext_adv_enable = 0x000076fd;
gap_set_ext_adv_para = 0x0000776d;
gap_set_ext_scan_enable = 0x00007845;
gap_set_ext_scan_para = 0x0000785d;
gap_set_ext_scan_response_data = 0x000078fd;
gap_set_host_channel_classification = 0x00007915;
gap_set_periodic_adv_data = 0x00007925;
gap_set_periodic_adv_enable = 0x00007995;
gap_set_periodic_adv_para = 0x000079a5;
gap_set_phy = 0x000079bd;
gap_set_random_device_address = 0x000079d9;
gap_start_ccm = 0x00007a09;
gap_test_end = 0x00007a51;
gap_tx_test_v2 = 0x00007a5d;
gap_tx_test_v4 = 0x00007a75;
gap_update_connection_parameters = 0x00007a99;
gap_vendor_tx_continuous_wave = 0x00007ad9;
gatt_client_cancel_write = 0x00008001;
gatt_client_discover_characteristic_descriptors = 0x00008027;
gatt_client_discover_characteristics_for_handle_range_by_uuid128 = 0x00008067;
gatt_client_discover_characteristics_for_handle_range_by_uuid16 = 0x000080b7;
gatt_client_discover_characteristics_for_service = 0x00008107;
gatt_client_discover_primary_services = 0x0000813d;
gatt_client_discover_primary_services_by_uuid128 = 0x0000816f;
gatt_client_discover_primary_services_by_uuid16 = 0x000081b3;
gatt_client_execute_write = 0x000081ef;
gatt_client_find_included_services_for_service = 0x00008215;
gatt_client_get_mtu = 0x00008243;
gatt_client_is_ready = 0x000082e1;
gatt_client_listen_for_characteristic_value_updates = 0x000082f7;
gatt_client_prepare_write = 0x00008317;
gatt_client_read_characteristic_descriptor_using_descriptor_handle = 0x00008353;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle = 0x0000837d;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle_with_offset = 0x00008383;
gatt_client_read_long_value_of_characteristic_using_value_handle = 0x000083b1;
gatt_client_read_long_value_of_characteristic_using_value_handle_with_offset = 0x000083b7;
gatt_client_read_multiple_characteristic_values = 0x000083e5;
gatt_client_read_value_of_characteristic_using_value_handle = 0x00008415;
gatt_client_read_value_of_characteristics_by_uuid128 = 0x00008443;
gatt_client_read_value_of_characteristics_by_uuid16 = 0x0000848f;
gatt_client_register_handler = 0x000084d9;
gatt_client_reliable_write_long_value_of_characteristic = 0x000084e5;
...
hci_add_event_handler = 0x0000a021;
hci_power_control = 0x0000a7a9;
hci_register_acl_packet_handler = 0x0000a95d;
kv_commit = 0x0000b0ed;
kv_get = 0x0000b149;
kv_init = 0x0000b155;
kv_init_backend = 0x0000b1d1;
kv_put = 0x0000b1e5;
kv_remove = 0x0000b1f1;
kv_remove_all = 0x0000b225;
kv_value_modified = 0x0000b255;
kv_value_modified_of_key = 0x0000b271;
kv_visit = 0x0000b27d;
l2cap_add_event_handler = 0x0000b30d;
l2cap_can_send_packet_now = 0x0000b31d;
l2cap_create_le_credit_based_connection_request = 0x0000b4d9;
l2cap_credit_based_send = 0x0000b61d;
l2cap_credit_based_send_continue = 0x0000b649;
l2cap_disconnect = 0x0000b6c5;
l2cap_get_le_credit_based_connection_credits = 0x0000b915;
l2cap_get_peer_mtu_for_local_cid = 0x0000b931;
l2cap_init = 0x0000bd05;
l2cap_le_send_flow_control_credit = 0x0000bdfb;
l2cap_max_le_mtu = 0x0000c105;
l2cap_register_packet_handler = 0x0000c22d;
l2cap_register_service = 0x0000c239;
l2cap_request_can_send_now_event = 0x0000c349;
l2cap_request_connection_parameter_update = 0x0000c363;
...
ll_aes_encrypt = 0x0000cab5;
ll_config = 0x0000cb31;
ll_free = 0x0000cb67;
