...
gap_add_dev_to_periodic_list = 0x000073cd;
gap_add_whitelist = 0x000073dd;
gap_aes_encrypt = 0x000073e9;
gap_clear_white_lists = 0x00007421;
gap_clr_adv_set = 0x0000742d;
gap_clr_periodic_adv_list = 0x00007439;
gap_create_connection_cancel = 0x00007445;
gap_default_periodic_adv_sync_transfer_param = 0x00007451;
gap_disconnect = 0x00007469;
...
gap_set_connection_cte_tx_param = 0x00007965;
gap_set_connection_parameter_range = 0x000079b1;
gap_set_connectionless_cte_tx_enable = 0x000079cd;
gap_set_connectionless_cte_tx_param = 0x000079dd;
gap_set_connectionless_iq_sampling_enable = 0x00007a39;
gap_set_data_length = 0x00007a95;
gap_set_def_phy = 0x00007aad;
gap_set_ext_adv_data = 0x00007abd;
gap_set_ext_adv_enable = 0x00007ad5;
gap_set_ext_adv_para = 0x00007b45;
gap_set_ext_scan_enable = 0x00007c1d;
gap_set_ext_scan_para = 0x00007c35;
gap_set_ext_scan_response_data = 0x00007cd5;
gap_set_host_channel_classification = 0x00007ced;
gap_set_periodic_adv_data = 0x00007cfd;
gap_set_periodic_adv_enable = 0x00007d6d;
gap_set_periodic_adv_para = 0x00007d7d;
gap_set_periodic_adv_rx_enable = 0x00007d95;
gap_set_phy = 0x00007da5;
gap_set_random_device_address = 0x00007dc1;
gap_start_ccm = 0x00007df1;
gap_test_end = 0x00007e39;
gap_tx_test_v2 = 0x00007e45;
gap_tx_test_v4 = 0x00007e5d;
gap_update_connection_parameters = 0x00007e81;
gap_vendor_tx_continuous_wave = 0x00007ec5;
...
gatt_client_is_ready = 0x000086d1;
gatt_client_listen_for_characteristic_value_updates = 0x000086e7;
gatt_client_prepare_write = 0x00008709;
gatt_client_read_characteristic_descriptor_using_descriptor_handle = 0x00008745;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle = 0x0000876f;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle_with_offset = 0x00008775;
gatt_client_read_long_value_of_characteristic_using_value_handle = 0x000087a3;
gatt_client_read_long_value_of_characteristic_using_value_handle_with_offset = 0x000087a9;
gatt_client_read_multiple_characteristic_values = 0x000087d7;
gatt_client_read_value_of_characteristic_using_value_handle = 0x00008807;
gatt_client_read_value_of_characteristics_by_uuid128 = 0x00008835;
gatt_client_read_value_of_characteristics_by_uuid16 = 0x00008881;
gatt_client_register_handler = 0x000088cd;
gatt_client_reliable_write_long_value_of_characteristic = 0x000088d9;
gatt_client_signed_write_without_response = 0x00008d09;
gatt_client_write_characteristic_descriptor_using_descriptor_handle = 0x00008dcd;
gatt_client_write_client_characteristic_configuration = 0x00008e07;
gatt_client_write_long_characteristic_descriptor_using_descriptor_handle = 0x00008e59;
gatt_client_write_long_characteristic_descriptor_using_descriptor_handle_with_offset = 0x00008e69;
gatt_client_write_long_value_of_characteristic = 0x00008ea5;
gatt_client_write_long_value_of_characteristic_with_offset = 0x00008eb5;
gatt_client_write_value_of_characteristic = 0x00008ef1;
gatt_client_write_value_of_characteristic_without_response = 0x00008f27;
hci_add_event_handler = 0x0000a469;
hci_power_control = 0x0000ac0d;
hci_register_acl_packet_handler = 0x0000adc1;
kv_commit = 0x0000b571;
kv_get = 0x0000b5cd;
kv_init = 0x0000b5d9;
kv_init_backend = 0x0000b659;
kv_put = 0x0000b66d;
kv_remove = 0x0000b679;
kv_remove_all = 0x0000b6ad;
kv_value_modified = 0x0000b6dd;
kv_value_modified_of_key = 0x0000b6f9;
kv_visit = 0x0000b705;
l2cap_add_event_handler = 0x0000b795;
l2cap_can_send_packet_now = 0x0000b7a5;
l2cap_create_le_credit_based_connection_request = 0x0000b961;
l2cap_credit_based_send = 0x0000baa5;
l2cap_credit_based_send_continue = 0x0000bad1;
l2cap_disconnect = 0x0000bb4d;
l2cap_get_le_credit_based_connection_credits = 0x0000bd9d;
l2cap_get_peer_mtu_for_local_cid = 0x0000bdb9;
l2cap_init = 0x0000c18d;
l2cap_le_send_flow_control_credit = 0x0000c283;
l2cap_max_le_mtu = 0x0000c58d;
...
l2cap_send_echo_request = 0x0000ccc5;
l2cap_unregister_service = 0x0000cd85;
le_device_db_add = 0x0000cddd;
le_device_db_find = 0x0000ceb5;
le_device_db_from_key = 0x0000cee1;
le_device_db_iter_cur = 0x0000cee9;
le_device_db_iter_cur_key = 0x0000ceed;
le_device_db_iter_init = 0x0000cef1;
le_device_db_iter_next = 0x0000cef9;
le_device_db_remove_key = 0x0000cf1f;
ll_aes_encrypt = 0x0000cf4d;
ll_config = 0x0000cfc9;
ll_free = 0x0000cfff;
ll_get_heap_free_size = 0x0000d009;
