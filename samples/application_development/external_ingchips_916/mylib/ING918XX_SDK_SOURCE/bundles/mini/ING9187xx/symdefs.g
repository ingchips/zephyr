...
att_server_indicate = 0x00006035;
att_server_init = 0x000060b9;
att_server_notify = 0x000060f5;
att_server_register_packet_handler = 0x0000620d;
att_server_request_can_send_now_event = 0x00006219;
att_set_db = 0x00006235;
att_set_read_callback = 0x00006249;
att_set_write_callback = 0x00006255;
bd_addr_cmp = 0x000063c5;
bd_addr_copy = 0x000063cb;
bd_addr_to_str = 0x000063d5;
big_endian_read_16 = 0x0000640d;
big_endian_read_32 = 0x00006415;
big_endian_store_16 = 0x00006429;
big_endian_store_32 = 0x00006435;
btstack_config = 0x00006589;
btstack_memory_pool_create = 0x000066c7;
btstack_memory_pool_free = 0x000066f1;
btstack_memory_pool_get = 0x00006751;
btstack_push_user_msg = 0x000067b9;
btstack_push_user_runnable = 0x000067c5;
btstack_reset = 0x000067d1;
char_for_nibble = 0x00006aad;
eTaskConfirmSleepModeStatus = 0x00006d91;
gap_add_dev_to_periodic_list = 0x0000738d;
gap_add_whitelist = 0x0000739d;
gap_aes_encrypt = 0x000073a9;
gap_clear_white_lists = 0x000073e1;
gap_clr_adv_set = 0x000073ed;
gap_clr_periodic_adv_list = 0x000073f9;
gap_create_connection_cancel = 0x00007405;
gap_disconnect = 0x00007411;
...
gap_periodic_adv_term_sync = 0x00007629;
gap_read_periodic_adv_list_size = 0x000076b1;
gap_read_phy = 0x000076bd;
gap_read_remote_used_features = 0x000076c9;
gap_read_remote_version = 0x000076d5;
gap_read_rssi = 0x000076e1;
...
gap_set_ext_scan_enable = 0x000079b9;
gap_set_ext_scan_para = 0x000079d1;
gap_set_ext_scan_response_data = 0x00007a71;
gap_set_host_channel_classification = 0x00007a89;
gap_set_periodic_adv_data = 0x00007a99;
gap_set_periodic_adv_enable = 0x00007b09;
gap_set_periodic_adv_para = 0x00007b19;
gap_set_phy = 0x00007b31;
gap_set_random_device_address = 0x00007b4d;
gap_start_ccm = 0x00007b7d;
gap_test_end = 0x00007bc5;
gap_tx_test_v2 = 0x00007bd1;
gap_tx_test_v4 = 0x00007be9;
gap_update_connection_parameters = 0x00007c0d;
gap_vendor_tx_continuous_wave = 0x00007c4d;
gatt_client_cancel_write = 0x00008175;
gatt_client_discover_characteristic_descriptors = 0x0000819b;
gatt_client_discover_characteristics_for_handle_range_by_uuid128 = 0x000081db;
gatt_client_discover_characteristics_for_handle_range_by_uuid16 = 0x0000822b;
gatt_client_discover_characteristics_for_service = 0x0000827b;
gatt_client_discover_primary_services = 0x000082b1;
gatt_client_discover_primary_services_by_uuid128 = 0x000082e3;
gatt_client_discover_primary_services_by_uuid16 = 0x00008327;
gatt_client_execute_write = 0x00008363;
gatt_client_find_included_services_for_service = 0x00008389;
gatt_client_get_mtu = 0x000083b7;
gatt_client_is_ready = 0x00008455;
gatt_client_listen_for_characteristic_value_updates = 0x0000846b;
gatt_client_prepare_write = 0x0000848b;
gatt_client_read_characteristic_descriptor_using_descriptor_handle = 0x000084c7;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle = 0x000084f1;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle_with_offset = 0x000084f7;
gatt_client_read_long_value_of_characteristic_using_value_handle = 0x00008525;
gatt_client_read_long_value_of_characteristic_using_value_handle_with_offset = 0x0000852b;
gatt_client_read_multiple_characteristic_values = 0x00008559;
gatt_client_read_value_of_characteristic_using_value_handle = 0x00008589;
gatt_client_read_value_of_characteristics_by_uuid128 = 0x000085b7;
gatt_client_read_value_of_characteristics_by_uuid16 = 0x00008603;
gatt_client_register_handler = 0x0000864d;
gatt_client_reliable_write_long_value_of_characteristic = 0x00008659;
...
hci_power_control = 0x0000a91d;
hci_register_acl_packet_handler = 0x0000aad1;
kv_commit = 0x0000b239;
kv_get = 0x0000b295;
kv_init = 0x0000b2a1;
kv_init_backend = 0x0000b31d;
kv_put = 0x0000b331;
kv_remove = 0x0000b33d;
...
l2cap_init = 0x0000be51;
l2cap_le_send_flow_control_credit = 0x0000bf47;
l2cap_max_le_mtu = 0x0000c251;
l2cap_register_packet_handler = 0x0000c379;
l2cap_register_service = 0x0000c385;
...
ll_hint_on_ce_len = 0x0000ccd1;
ll_legacy_adv_set_interval = 0x0000cd09;
ll_malloc = 0x0000cd19;
ll_query_timing_info = 0x0000ce51;
ll_register_hci_acl_previewer = 0x0000ce9d;
ll_scan_set_fixed_channel = 0x0000cf01;
ll_set_adv_access_address = 0x0000d119;
ll_set_adv_coded_scheme = 0x0000d125;
ll_set_conn_acl_report_latency = 0x0000d14d;
ll_set_conn_coded_scheme = 0x0000d179;
ll_set_conn_latency = 0x0000d1a1;
ll_set_conn_tx_power = 0x0000d1cd;
ll_set_def_antenna = 0x0000d211;
ll_set_initiating_coded_scheme = 0x0000d22d;
ll_set_max_conn_number = 0x0000d239;
